...
public class PersonalLoanEMITest extends TestBase {
    public static Logger log = LogManager.getLogger(PersonalLoanEMITest.class.getName());
    WebDriver driver;
    ...
    @Test(dataProviderClass = DataProviders.class,dataProvider = "getDataForPersonalLoan", groups = {"Regression", "Sanity"})
    public void testPersonalLoanEMI(String loanAmount, String interestRate, String loanTenure, String expectedEmi, String expectedInterest) {

        HomePage homePage = new HomePage(driver);

        Actions actions = new Actions(driver);
        homePage.getPersonalLoanTab().click();
    ...
    @Test(dataProviderClass = DataProviders.class,dataProvider = "getDataForPersonalLoan", groups = {"Regression"})
    public void testPersonalLoanInterest(String loanAmount, String interestRate, String loanTenure, String expectedEmi, String expectedInterest) {
        HomePage homePage = new HomePage(driver);
